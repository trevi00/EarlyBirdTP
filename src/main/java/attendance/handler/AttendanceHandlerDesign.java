...
public class AttendanceHandlerDesign {
    ...
    public static void showAttendanceMessage(JFrame parent, int messageType) {
        ...
        int width = parent.getContentPane().getWidth(); //bgIcon.getIconWidth();
        int height = parent.getContentPane().getHeight(); //bgIcon.getIconHeight();
        ...
        dialog.setUndecorated(false); // 테두리 적용
